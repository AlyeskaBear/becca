...
class DaisyChain(object):
    """
    An incremental sequence learning algorithm
    ...
    The daisychain is the basis for sequence-building in the agent.
    Daisychained channels are later clustered by a ziptie into features.
    It is also the basis for prediction. 
    It incrementally estimates the likelihood that a post cable 
    will be active given the set of pre cables that have recently
    been active. Each pre-post chain also tracks a count of how many
    ...
    def __init__(self, max_num_cables, name):
        ...
        #self.AGING_TIME_CONSTANT = 10 ** 10 # real, large
        self.CHAIN_UPDATE_RATE = .1 # real, 0 < x < 1
